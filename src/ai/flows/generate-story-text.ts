...
1.  **Character Limit:** The final output string MUST NOT exceed 90 characters.
...
6.  **Prioritization & Maximization:** Prioritize features in this order: bedrooms, suites, garage spaces, gourmet area, pool. After these, add as many other important features as possible without exceeding the 90-character limit. Be concise (e.g., use "Área Gourmet" instead of "Espaço com área gourmet").
...
Now, process the following raw text and generate the formatted story text:
{{{rawText}}}
`,
});
